      ...
      <div className="page-section">
        <Container>
          <div className="content">
            ...
            <p>
              Design tokens are the foundation of Sistent's design system. They
              are named values that store visual design attributes like colors,
              spacing, and typography scales. Instead of hardcoding values like{" "}
              <code>#00B39F</code> or <code>16px</code>, you reference semantic
              tokens that automatically adapt to different themes and contexts.
            </p>
            ...
            <p>
              All design tokens are available through the theme object using the{" "}
              ...
              <div className="items">
                <SistentThemeProvider initialMode={isDark ? "dark" : "light"}>
                  ...
                  >
                    ...
                    >
                      A beautifully designed card component using Sistent design
                      tokens for consistent styling and theming.
                    </Typography>
                    <Typography
                      variant="h6"
                      color="primary.main"
            ...
            <ul>
              ...
              <li>
                Use <code>useTheme()</code> hook to access all available design
                tokens
              </li>
              <li>
