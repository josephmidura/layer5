...
<div>
  ...
  <ul>
    ...
    <li>
      ...
      <a href="https://twitter.com/lcalcote" target="_blank" rel="noreferrer">@lcalcote</a>), Otto van der Schaaf
      (<a href="https://twitter.com/oschaaf" target="_blank" rel="noreferrer">@oschaaf</a>)
    </li>
    <li>
      <b>Issue(s)</b>:
...
<div>
  ...
  <ul>
    ...
    <li>
      <b>Mentor(s)</b>: Lee Calcote (
      <a href="https://twitter.com/lcalcote" target="_blank" rel="noreferrer">@lcalcote</a>), Abishek Kumar (
      <a href="https://twitter.com/kumarabd" target="_blank" rel="noreferrer">@kumarabd</a>)
    </li>
    <li>
...
<div>
  ...
  <ul>
    <li>
      ...
      same cloud native, 2) heterogeneous workloads (Kubernetes, VMs, Bare metal)
      using the same cloud native, 3) multiple Kubernetes clusters using
      different cloud native (e.g. Istio and Linkerd), 4) heterogeneous
      workloads using different cloud native (e.g. Istio, Consul).
    </li>
    <li>
